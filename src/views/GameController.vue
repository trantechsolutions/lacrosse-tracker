<template>
  <div class="container-fluid py-3">
    ...
    <div class="row">
      <div class="col-6">
        <PenaltyForm :newPenalty="newPenalty" :gameClock="gameClock" :activePenalties="activePenalties"
          :expiredPenalties="expiredPenalties" @clearPenalties="clearPenalties" @addPenalty="addPenalty" />
      </div>
      <div class="col-6">
